    ...
    <div>
      ...
      <div className="flex space-x-4 overflow-x-auto pb-2">
        {templates.map(template => (
          ...
          >
            <div
              className={`w-28 h-40 bg-gray-200 dark:bg-slate-700 rounded-lg overflow-hidden border-2 transition-all duration-200 ${
            ...
            <p className={`mt-2 text-sm text-center font-medium transition-colors ${
                currentTemplateId === template.id 
