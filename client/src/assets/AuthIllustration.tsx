...
export const AuthIllustration: React.FC<React.SVGProps<SVGSVGElement>> = (props) => (
  <svg viewBox="0 0 512 512" xmlns="http://www.w3.org/2000/svg" {...props}>
    ...
    >
        <rect x="128" y="180" width="256" height="150" rx="15" fill="url(#grad2)" stroke="white" strokeWidth="2" />
        ...
        <path d="M150 220 H 362" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.3"/>
        <path d="M150 240 H 300" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.3"/>
        <path d="M150 260 H 340" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.3"/>
        <path d="M150 280 H 280" stroke="white" strokeWidth="2" strokeLinecap="round" opacity="0.3"/>
    </motion.g>
    ...
    >
     ...
     >
        ...
        <path d="M95 140 L105 140 M95 150 L105 150 M95 160 L105 160" stroke="white" strokeWidth="3" strokeLinecap="round"/>
     </motion.g>
